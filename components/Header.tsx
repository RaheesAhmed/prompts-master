    ...
    <nav className="bg-gray-100 pt-5 shadow-md">
      <div className="container mx-auto px-6 py-3 flex justify-between items-center">
        ...
        <div className="flex items-center space-x-4">
          <a href="/prompts" className="text-blue  to-blue-700 hover:from-blue-600 hover:to-blue-800 px-4 py-2 rounded-lg transition-all">Test Prompts</a>
          <a href="/prompts/analyze" className="text-blue  to-blue-700 hover:from-blue-600 hover:to-blue-800 px-4 py-2 rounded-lg transition-all">Analyze</a>
